# Land Use & Developable-Land Analysis — Canyon Ridge — Decisions Log
...
- Address: 2552 E Gowen Rd, Boise, ID 83716 — Canyon Ridge.
- Verified point: 43.541734, -116.151198 (ArcGIS World GeocodeServer, PointAddress, score 100).
- Canyon Ridge is a 287-unit, 4-story apartment community completed 2024 on the south/southeast side of Boise Airport (Gowen Field), in the Columbia Village / Columbia Town Center area along E Gowen Rd. The verified point sits on the Columbia Town Center MX-2 node (~0.1 mi from the apartment footprint) — immaterial at a 5-mi radius. The subject sits INSIDE the Airport Influence Area, where new residential is restricted/prohibited in Zones B and C.
...
- Area spans: Boise Airport (BOI)/Gowen Field; the Micron HQ + fab expansion on the Columbia bench; the Gowen Rd / Federal Way / Eisenman / S Orchard industrial corridor (CCDC Gateway East urban-renewal district); Columbia Village; the Parkcenter / Boise River / Barber Valley edge; and unincorporated Ada County rural-urban frontier to the south and east.
