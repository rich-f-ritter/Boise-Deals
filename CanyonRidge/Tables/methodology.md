1. Subject resolution — geocoded 2552 E Gowen Rd, Boise, ID 83716 to 43.541734, -116.151198 (verified against satellite + parcel).
...
8. Deliverables — this workbook (fully auditable), an interactive HTML map viewer (land use / zoning /
   vacant-threat), and a head-to-head developable-land comparison with Seasons at Meridian.
