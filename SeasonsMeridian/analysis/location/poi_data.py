...
POIS = [
    ...
    dict(cat="emp", name="T-Mobile call center", lat=43.5851, lon=-116.3527, d=0.63,
         note="3265 E Goldstone Way (El Dorado campus) · 77,500 SF, ~500 employees (CoStar). Location approximate."),
