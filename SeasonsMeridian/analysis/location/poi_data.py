...
POIS = [
    ...
    dict(cat="emp", name="West Ada School District HQ", lat=43.595874, lon=-116.378609, d=0.93,
         note="1303 E Central Dr · administrative HQ + district service center of Idaho's largest school district (~39K students), next door to ISU-Meridian."),
    dict(cat="emp", name="Scentsy Commons (HQ)", lat=43.610703, lon=-116.360838, d=1.29,
         pkey="scentsy", badge=[43.6105, -116.3590],
         note="2701 E Pine Ave · 70-acre Scentsy Commons campus; 170,500-SF HQ, ~1,100 employees (CoStar; two layoff rounds 2025-26)."),
    ...
    dict(cat="emp", name="Franklin–Pine employment corridor", lat=43.6068, lon=-116.3560, d=1.05,
         pkey="beltFP", badge=[43.6068, -116.3548],
         note="The rail-served industrial/flex corridor running from Franklin Rd up to Pine Ave and the UPRR line, Eagle Rd east: 68 tenants \u226510K SF / 2.8M SF / ~5,400 reported jobs (CoStar) across the corridor, including the separately-outlined Scentsy and Blue Cross campuses at its center — plus Albertsons' 253K-SF distribution center, Shamrock Foods (125K), RC Willey (159K), Coca-Cola bottling, Francini (580 jobs), JST, Bastian Solutions, Idaho DOC offices, Idaho Foodbank. Outline = the corridor's commercial/industrial parcels, dissolved (campus outlines excluded)."),
    dict(cat="emp", name="Micron — Meridian facility", lat=43.609288, lon=-116.350818, d=1.29,
         note="3475 E Commercial Ct · 61,000 SF, ~300 employees (CoStar) — Micron operations inside the ring, separate from the Federal Way fab campus. Micron is the subject's #3 resident employer (10 residents)."),
    ...
    dict(cat="retail", name="The Village at Meridian", lat=43.622481, lon=-116.351337, d=2.16,
         ...
         note="Eagle & Fairview · ~1M-SF open-air lifestyle center (CenterCal): Village Cinema luxury theater, summer concert series, and Idaho's first In-N-Out (opened Dec 2023 on the Fairview frontage). Phase II (80,000 SF, 6 buildings — Williams Sonoma, Pottery Barn, The Capital Grille, Culinary Dropout, Vuori, Alo...) opens Sept 2026 – Feb 2027."),
    ...
    dict(cat="ent", name="Cinemark Majestic Cinemas", lat=43.592375, lon=-116.368985, d=0.41,
         note="2140 E Cinema Dr · 69,000-SF multiplex a 0.4-mi walk west of the subject — the planned Cinema Dr extension through the adjacent WinCo site points straight at it."),
    ...
    dict(cat="far", name="Downtown Boise", lat=43.61512, lon=-116.201382, d=8.14,
         note="~10 mi / ~15 min via I-84-I-184 from the subject's on-ramp · state capital + HQ cluster: Simplot (~1,000 downtown), Idaho Power (1,840), Clearwater Analytics (~480), Albertsons corporate."),
    dict(cat="far", name="Boise Airport (BOI)", lat=43.560057, lon=-116.208075, d=7.90,
         note="~10 mi / ~14 min east on I-84."),
    dict(cat="far", name="Saint Alphonsus Regional Medical Center", lat=43.612648, lon=-116.257425, d=5.36,
         note="1055 N Curtis Rd, Boise · Trinity Health's Idaho flagship (system ~6,000+ employees) — the subject's #2 resident employer (13 residents per the tenant demographics report); its Ten Mile Crossing surgery center and Meridian clinics are in-ring."),
