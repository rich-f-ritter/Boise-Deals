...
> **v4 UPDATE (Placer.ai device data through June 2026 — appendix K):** migration did NOT pause — it **re-accelerated to a five-year high**. YE June 2026: ~+11.6K net domestic migration (nearly double YE June 2025), Boise **#5 of 925 US CBSAs** in net migration (+1.45% rate), Ada County **#8 of 3,126 US counties**, California = 47% of net inflow, the DC feeder doubled (federal exodus), and **the subject's ZIP 83642 is the metro's #1 in-migration ZIP (+2,417, accelerating)** while north Meridian decelerated. The labor-force "contraction" below is best read alongside this as a population-control lag and/or non-working migrant mix — housing demand is running ahead of every payroll statistic.

- Ada County added ~10,916 people in the year to July 2025 — its largest gain in Idaho, faster than 2024; ~75% of Idaho's growth is net in-migration (⇒ ~8,000+ net migrants into Ada in 2025, derived). California is the #1 feeder. The **T3M labor-force contraction (−0.79%)** now reads as a statistical artifact/composition effect given the Placer re-acceleration — but underwrite conservatively until Census Vintage 2026 confirms (Dec 2026–Mar 2027).
